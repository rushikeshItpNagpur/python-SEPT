...
let filterCategory=document.getElementById("filterByCategory")
         ...
         let card=document.createElement("div")
          ...
          let title=document.createElement("h3") 
           ...
           let price=document.createElement("h2")
               price.innerText=`product price - ${el.price}`
...
function filterByCategory(){
  let val=filterCategory.value
    ...
    if(val=="mens"){
       ...
       let abc=data.filter(function(el,i,arr) {
...
let arr=[5,94,9,8,49,16,4,6,5,4,65,1]
